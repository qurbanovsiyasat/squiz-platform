-- Migration: create_qa_search_functions_fixed
-- Created at: 1754327776

-- Migration: create_qa_search_functions_fixed
-- Created at: 1754316921
-- Create search functions for Q&A questions (fixed)

-- Drop existing functions that might conflict
DROP FUNCTION IF EXISTS increment_qa_question_views(UUID);
